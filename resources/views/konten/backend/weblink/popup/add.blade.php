...
<div class='form-group'>
	...
	<input autofocus type='text' name='nama' id='nama' placeholder='nama weblink...' class='form-control' />
</div>

<div class='form-group'>
	{!! Form::label('url', 'Url Weblink : ') !!}
	<input autofocus type='text' value='http://' name='url' id='url' placeholder='url weblink...' class='form-control' />
</div>
...
<div class='form-group'>
	...
	{!! Form::select('mst_kategori_weblink_id', Fungsi::get_dropdown($kategori, 'kategori'), '', 
...
$('#simpan').attr('disabled', 'disabled');
	$.ajax({
		url : '{{ URL::route("admin_weblink.insert") }}',
		data : form_data,
		type : 'post',
