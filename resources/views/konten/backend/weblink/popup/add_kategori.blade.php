...
<h3>tambah kategori weblink</h3>
<hr style='margin:2px'>



<div class='form-group'>
	<input autofocus type='text' name='nama' id='nama' placeholder='nama kategori...' class='form-control' />
</div>
...
$('#simpan').attr('disabled', 'disabled');
	$.ajax({
		url : '{{ URL::route("admin_weblink.insert_kategori") }}',
		data : form_data,
		type : 'post',
