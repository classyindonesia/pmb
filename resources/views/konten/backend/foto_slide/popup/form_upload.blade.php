...
<input type='text' name='nama' placeholder='nomor induk...' id='no_induk' class='form-control' />

{!! Form::select('ref_jabatan_id', Fungsi::get_dropdown($ref_jabatan, 'jabatan'), 
    '', ['class' => 'form-control', 'id' => 'ref_jabatan_id']) !!}
...
<div class="fileUpload btn btn-primary">
    <span> <i class="fa fa-link"></i> pilih file </span>
     <input 
        ...
        type="file"
        name="files" 
        data-url="{!! URL::route('foto_slide.do_upload') !!}" 
