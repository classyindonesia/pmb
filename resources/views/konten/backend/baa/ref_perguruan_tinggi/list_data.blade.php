<table class="table table-bordered table-hover">
	...
	<tbody>
<?php $no=$ref_perguruan_tinggi->firstItem(); ?>
@foreach($ref_perguruan_tinggi as $list)
		<tr>
			...
			||
				{!! Action::edit(false, route("backend_ref_perguruan_tinggi.edit", $list->id), $list->id) !!}
			</td>
		</tr>
		<?php $no++; ?>
@endforeach
